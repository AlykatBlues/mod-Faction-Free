...
2. Change to the dev_w database with:  USE dev_w;
...
SELECT `entry`, `name`, `subname`, `faction`, `npcflag` FROM `dev_w`.`creature_template` WHERE `entry` IN (500000, 500001);
/*Check to see if GUIDs 500000000-500000019 are free to add the creature objects for the Teleport Network*/
SELECT `guid`, `id1`, `map`, `zoneId`, `areaId` FROM `dev_w`.`creature` WHERE `guid` BETWEEN 5000000 AND 5000019;
/*Check to see if entry 500000, 500001, and 500003 are free to add the broadcast text entries for the Teleport Network*/
SELECT `ID`, `LanguageID`, `MaleText`, `FemaleText` FROM `dev_w`.`broadcast_text` WHERE `ID` IN (500000, 500001, 500003);
/*Check to see if entry 500000, 500001, and 500003 are free to add the npc text entries for the Teleport Network*/
SELECT `ID`, `text0_0`, `text0_1`, `lang0` FROM `dev_w`.`npc_text` WHERE `ID` IN (500000, 500001, 500003);
/*Check to see if entry 500000-500004 are free to add the gameobject templates for the Teleport Network*/
SELECT `entry`, `type`, `displayId`, `name` FROM `dev_w`.`gameobject_template` WHERE `entry` BETWEEN 500000 AND 500004;
/*Check to see if GUIDs 500000000-500000049 are free to add the gameobjects for the Teleport Network*/
SELECT `guid`, `id`, `map`, `zoneId`, `areaId` FROM `dev_w`.`gameobject` WHERE `guid` BETWEEN 5000000 AND 5000049;
